<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="other.name" label="部门名称"></el-table-column>
      <el-table-column prop="level" label="层级" align="center" width="70"></el-table-column>
      <el-table-column prop="other.updateBy" label="最后修改人"></el-table-column>
      <el-table-column prop="other.updateTime" label="最后修改时间"></el-table-column>
